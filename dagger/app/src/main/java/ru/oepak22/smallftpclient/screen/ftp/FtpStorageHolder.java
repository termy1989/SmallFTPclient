...
public class FtpStorageHolder extends RecyclerView.ViewHolder {
    ...
    // конструктор
    public FtpStorageHolder(@NonNull View view, boolean isDialog) {
        super(view);
    ...
    public void bind(@NonNull RemoteFile file) {
