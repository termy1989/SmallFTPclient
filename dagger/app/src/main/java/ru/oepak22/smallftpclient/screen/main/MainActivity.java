...
public class MainActivity extends AppCompatActivity implements FtpConnectView {
    ...
    @Inject FilesService mFilesService;                                                                 // внедрение зависимости - интерфейс операций с файлами
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MainApp.getAppComponent().injectMainActivity(this);

        // инициализация презентера
        mFtpConnectPresenter = new FtpConnectPresenter(this, mRealmService, mFtpService);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Define.SD_ROOT && resultCode == RESULT_OK) {
            ...
            if (!path.split(":")[0].equals("/tree/primary")
                ...
                String sd = mFilesService.getSDcard();
    ...
    public void setNavigationMenu() {
        ...
        Pair<Long, Long> space = mFilesService.getSpace(Environment.getExternalStorageDirectory()
                                                                                        .getPath());
        ...
        if (sd != null) {
            ...
            space = mFilesService.getSpace(sd);
            ...
            localSubmenu.add(getResources().getStringArray(R.array.locals_with_sd)[5]
                        ...
                        .setOnMenuItemClickListener(menuItem -> {
                            ...
                            // проверка наличия SD-карты
                            String sdPath = mFilesService.getSDcard();
            ...
            localSubmenu.add(R.string.set)
                    .setOnMenuItemClickListener(menuItem -> {
                        if (mFilesService.getSDcard() != null)
