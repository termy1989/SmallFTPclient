...
public class FtpStorageFragment extends Fragment
                                    implements FtpStorageView,
    ...
    @Inject FtpService mService;                                                                            // внедрение зависимости - интерфейс операций FTP
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            MainApp.getAppComponent().injectFtpStorageFragment(this);

            // инициализация презентера
            mPresenter = new FtpStoragePresenter(this, mService, mServer, null);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        mEmptyView.setOnClickListener(view1 -> {
            if (!isClicked) {
                mPresenter = new FtpStoragePresenter(FtpStorageFragment.this,
                                                            mService, mServer, null);
                mPresenter.refresh();
                isClicked = true;
            }
        });
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_ftp_delete:
                ...
                if (selectedItems == null || selectedItems.isEmpty())
                    ...
                    ((MainActivity) requireActivity()).deleteFiles(mPresenter.getFtpServer(),
                                                                                null,
                                                                                getCurrentPath(),
                                                                                null,
                                                                                    selectedItems);
    ...
    public void init(FtpServer server, FTPClient client) {
        ...
        // инициализация презентера
        mPresenter = new FtpStoragePresenter(this, mService, mServer, client);
    }
    ...
    public FtpServer getServer() {
        return mPresenter.getFtpServer();
    }
