...
public class DownloadPresenter {
    ...
    // конструктор
    public DownloadPresenter(DownloadView view, Context context, FtpServer server,
        ...
        try {
            ...
            if (client.login(mServer.getUsername(), mServer.getPassword())) {
                ...
                if (inputStream != null && client.getReplyCode() != 550) {
                    ...
                    FilesProvider.provideFilesService().delete(mContext, downloadFile);
                    outputStream = FilesProvider.provideFilesService()
                                                    .getOutputStream(mContext, downloadFile);
